...
export const building = require('../assets/icons/building.png');
export const buy = require('../assets/icons/buy-button.png');
export const conversation = require('../assets/icons/conversation.png');
export const house = require('../assets/icons/house.png');
export const location = require('../assets/icons/location.png');
export const newspaper = require('../assets/icons/newspaper.png');
